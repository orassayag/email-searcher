...
// This enum define the input types of the user-authentication page.
export const UserAuthenticationInputType = createEnum(new Map([
    ['EMAIL', 'email'],
    ['PASSWORD', 'password']
]));

// This enum define the modal name types that can be displayed to
...
// This enum determine types of length characters of
...
// This enum determine types of validation function to take place on
...
// This enum define the error types to write in the console or to throw
...
// This enum define the API routes of the tables in the
...
// This enum define the possible search engines that the email item was
