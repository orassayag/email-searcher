...
// This enums determine the authentication mode of the user in user-authentication
...
// This enum used in order to manage the localStorage and user fields.
...
// This enum used to bring specific error message to the user that tries to
...
// This enum define the modal type that opens on the search-page (Home-page), when the user is not authenticated,
