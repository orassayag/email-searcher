...
const UISettings = {
    ...
    // Determine if the transition effect will appear when the user browse from page to page.
    ...
    // gone and the emails list will be display to the user in the search-page (Home-page).
    // The time is in milliseconds.
    ...
    // This limit meant to not harm the system and to not to over width the CPU.
    // The time is in milliseconds.
    searchStoreEmailDelay: 100,

    // Determine the number of durations to display the modal error message and
    // to keep the modal open until it will automatically be closed after unexpected
