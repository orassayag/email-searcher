// Settings for the production environment only. The settings effects on entire
// application behavior, URLs, keys, secrets, and other configurations. All the
// settings repeat themselves all over the site, so it's better to implement
// these settings and configurations in one file.

const applicationSettings = {

    // This field defines the API URL address of the REST API and the database.
    ...
    // to this API URL are related to any CRUD operations, except the user authentication
    ...
    // authentication actions against Firebase databases.
    ...
    // This field defines the creator's email address of the person who
    ...
    // This field defines the creator's full name of the person who built
    ...
    // put a link on the bottom of their page if you use some of them
    // free icon images. The link will open their site, and will be
    // placed on the bottom of the footer.
    iconsURL: 'https://icons8.com/',

    // This field determines the name of the icons URL provider that provided
    ...
    // This field defines the site application's creation year, and will be
    // displayed on the bottom of the footer. Also, it will be included in the
    // logic that will calculate the year that was created until the current year
    // and will be displayed on the footer, once the year is passed.
    applicationCreationYear: 2018,

    // This field determines the maximum capacity count limit of each user to
    ...
    // This field determines the initial keywords of each site application's
    ...
    // This field determines the default local culture of the site's language.
    ...
    // This flag field determines if on each time of the first load of the site,
    ...
    // This flag field determines if on the load for the first time, the operation will
