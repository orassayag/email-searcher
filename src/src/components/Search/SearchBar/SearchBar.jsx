...
import searchOptionsShape from '../../../models/proptypes/searchOptions';
...
const SearchBar = React.forwardRef((props, ref) => {
    ...
    const searchOptions = props.searchOptions.map(ctrl => {
        ...
        // Get the search options ref to scroll down on mobile devices. If it does not exist, throw an exception.
