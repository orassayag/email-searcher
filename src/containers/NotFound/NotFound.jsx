...
// he want and offer the user a button to click on and to be redirected
...
class NotFound extends Component {
    ...
    // This handler method handles a click of home-page button - To redirect the user back to search-page (Home-page).
    handleHomeClick = () => {
