// This file merge all watch of sagas related to user emails operations, to perform a
// call when needed, a saga that related to the user emails and other action
// operations. Once saga is called it will perform all its logic in synchronic order.
