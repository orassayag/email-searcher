...
class UserAuthentication {
    ...
    constructor(userAuthenticationData) {
        ...
        // The Id of the user as generated on database.
        ...
        // localStorage as string. In this case we only need to convert it to new Date.
    ...
    // This method determine if the user is logged-in to the system (With valid token) or not.
    ...
    isUserAuthenticated() {
        ...
        // Validate existence of parameters. If exists, check that the user token is not expired.
    ...
    // This method calculate the time left for the user
    ...
    getUserTokenLeftTime() {
        ...
        // Return the calculate expiration user token time.
