// This conversion file holds the method that convert a given data
// into new instances of UserAuthentication and UserEmails object instances.

import UserAuthentication from '../modals/UserAuthentication';
import UserEmails from '../modals/UserEmails';

// This function convert single data of strings into UserAuthentication and UserEmails object instances.
