// This file utile contains all the functions that related to the UI actions,
// like scrolling the window to an element, or load images, and other function.
// Only functions that related to the UI should be placed here.
...
export const getAuthenticationImageSourceByType = (authenticationRequiredModalType) => {
    ...
    // Check the existence of the authenticationRequiredModalType parameter. If not, return empty image source.
...
// This function check if the window size is more than 1170
// pixel width. If so, it's a not a small device screen or mobile screen.
// If less, it's a small device.
export const isStandartScreen = () => {
