// This component represent the top part of the application, includes links
...
// The one for mobile is "Hamburger" menu that displayed when clicked on a button
...
const Header = (props) => {
    ...
    if (isUserAuthenticated(props.userAuthentication)) {
        ...
        // If user name exists, create tab on the side with the username.
        ...
        // In case of not authenticated user, create appropriate data to display.
        headerData = {
