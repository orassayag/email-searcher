// This component is displayed inside a modal window, and take place when the
// user is authenticated to the application site in the search-page (In the
// home-page) when the user wants to ad specific email to his emails list.
...
// some input to add comments, that will be displayed on user-emails page.
