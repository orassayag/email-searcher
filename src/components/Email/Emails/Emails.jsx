// This component represent a list of Email components, and it displayed both
// on search-page (Home-page) and on user-emails page, and in both of theses
// pages there is an emails list that displayed to the user. In the search-page (Home-page),
