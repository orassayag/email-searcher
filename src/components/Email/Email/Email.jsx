// This component display an Email item (By instance of Email class) with all the details about the
// email fetches from search process or a fake email or user email.
// Since this is a multi-use component, the email can be displayed with full details panel (In user-emails page)
// or with minimum information in search-page (Home-page).
// The email display the email address, link, search engine, key, user comments, creation
// and added date, and also, an action item on the right side that change in depend of the
// page (User can add the email to his emails list on the search-page (Home-page), or
// can remove it in user-emails page from this emails list).
...
const Email = (props) => {
    ...
    // - Don't print the email data, but no need to throw error.
    ...
    // Create the template data that effects the logic of the email.
    ...
    // page, and for that, the actions of each emails are different,
    ...
    if (!props.isHomePage) {
        ...
        // If there are comments for the email, display them in appropriate component.
