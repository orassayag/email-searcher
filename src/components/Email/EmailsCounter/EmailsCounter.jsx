// This component displayed in the emails list of the user in user-emails page,
// to enable the user to select the count of email items to view each page.
// Each time the user changes his selection, the page refresh with the updated
...
const EmailsCounter = (props) => {
    ...
    // If the user is in search-page (Home-page), or have less than a logic settings number of emails, or for some
