// This index file is the root of all the application and the first file that
...
// mode, compose the enhancers, combine the reducers, middleware’s of all the sagas
...
// The main app component that hold the entire application.
const app = (
