// This component represents a floating modal window area that in the background there is
// blank gray color to let the user look and feel that only the modal window he needs
// to be focused on. The modal implements dynamic content, according to the situation
// that the user faced in. This component is actually the wrapper of another component that
// have content to display to the user, according to certain situations. For example,
// when the user tries to add email to this emails list on the search-page (Home-page)
// and he is not authenticated, this modal window will be displayed with a content that
...
const Modal = (props) => {
    ...
    if (props.isLoadingModal) {
        ...
        // If there is an unexpected error - Display a general error to the user. Note that while
