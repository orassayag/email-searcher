// This component displayed inside a modal window, and appears when the user is not
...
// on login / register button to be redirected to user-authentication page to
// perform login / registration process.
