// This component represents a number of links that enable the user to navigate through his
// emails list, according to the count of emails selected by the user, to display in each page.
// A list of links will be displayed according to the number of existing emails in the
// list, and to the user's userEmailsPagesCountToShow field. Some of the links may be disabled
// at a certain point of the navigation when the limit has been reached (Or in the beginning).
