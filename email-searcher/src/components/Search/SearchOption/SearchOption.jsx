// This component is a combination of a few components, and actually it's the whole search
// option component, that includes a switcher (SelectOption component), and text-area
