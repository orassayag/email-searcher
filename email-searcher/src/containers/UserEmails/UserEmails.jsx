...
    // This life-cycle handler method checks if the user is authenticated
...
    // This life-cycle handler method checks that the user is authenticated.
    componentDidUpdate() {

        // Check if the user is authenticated or not.
        this.handleCheckAuthentication();

        // If needed to scroll on mobile or small screens, call the function that does it.
...
    // This handler method is called when the user clicks on the X on each email's row icon on
...
        // Go to toggle delete email modal saga and try to open the modal to the user.
...
    // This handler method is called when the user clicks on the email row item to show / hide the full
...
    // This handler method is called when the user clicks on the 'Delete' button on the delete email modal
...
    // This handler method is called when the user updates the counter (Change the dropdown select) refresh
...
    // This handler method is called when the user clicks on the bottom pager numbers links
...
    // This handler method scrolls to emails list (Only on mobile devices or small screens only).
    handleScrollToElement = () => {

        // If the user is not on a mobile device or small screen - Don't scroll.
        if (isStandardScreen()) {
...
    // This handler method checks if the user is not authenticated or the user token expired
...
                // Check if any emails exist on the user's emails list. If not, display an appropriate message.
