...
// language, like cloning an object, creating an updated array from two existing
// arrays, and other actions. Only core functions need to be placed here.
...
// This function detects if the browser that the user currently uses is Google Chrome or not.
export const isChromeBrowser = () => {
    ...
    if (isIOSChrome) {
        ...
        // Check if Chrome is on other platforms.
        isChromium !== null &&
...
// This function returns to development mode the enhancer to enable redux dev tools.
...
// This function performs deep cloning on objects (Without methods prototypes).
export const updateObject = (updateObjectData) => {
    ...
    // Return a new calculated object.
    return {
...
// This function performs deep cloning on objects (With methods prototypes).
...
// This function performs deep cloning on objects with an update operation of new properties (With methods prototypes).
...
// This function makes a deep clone copy of an array of objects.
...
// This function takes a map of elements and converts them to freeze objects (Enum-like object).
...
// This function returns the current function name that is executing at the moment of calling.
...
export const getFunctionName = () => {
    ...
    // Check that the stack exists. If not, don't continue.
    if (!stack) {
