// This file includes all the functions needed to generate fake
...
// limits are configured and placed.
...
    // Return a random string by count.
    return generateRandomString(fakeSettings.idStringLength);
};

// This function generates random email addresses.
...
// This function generates random links.
...
// This function generates random search engines.
const generateRandomSearchEngine = () => {

    // Return a random search engine.
...
    // Random bool will determine if to generate comments or to return empty strings as comments.
...
    // Validate the generateData parameters. If not exists or invalid, don't generate fake emails.
...
        // If the emails length array equals the emails count, no need for random generation, just take all the sample emails.
