// This is a hoc container component, that enables the effect of fade-in and
// fade-out when routing and navigating between pages. The random function is
// placed because we want to sometimes fade-in and fade-out the effect, not always
// perform the same effect to let the user feel like something is changing and no
