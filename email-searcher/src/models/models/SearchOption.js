...
        // This field holds the key and the type of the search option from
...
        // This flag field will determine if the search option is displayed
        // to the user or not, also will determine if to validate the input
        // that the user entered. For example, if the user selects to perform
