...
// This action function is called when the login / registration processes are
// successfully performed and the user is now logged-in to the system.
...
// This action function is called when the logout process is
// successfully performed and the user is now logged-out from the system.
...
// This action function is called when all the validations have passed and the process of
// adding the email to the user's emails list is ready to go on the search-page (Home-page).
...
// This action function is called when there are no emails for the user on his emails
...
// This action function is called when the first time the user-emails
...
// unexpected error, and displayed a general error message to the user.
...
// This action function called when getting a user emails operation process was successfully
...
// This action function is called when the user clicks on an email row item to display full
...
// This action function is called when the user updates the counter drop down select
...
// This action function is called when the user updates the page number on the bottom
...
// This action function is called when the user clicks on the email
...
// This action function is called when the user deletes the email successfully from his
// emails list and to close the window after deleting the email from his emails list.
...
// This action function is called when the delete email process is finished or
...
// This action function is called when the user clicks on the 'Delete' button on the delete user email modal window
...
// prepared to delete the email from the user emails list by calling the API server - Show animation loader to the user.
...
// This action function is called when there is an unexpected while
...
// To close the modal window and to show the user that the email's row was faded out and deleted.
