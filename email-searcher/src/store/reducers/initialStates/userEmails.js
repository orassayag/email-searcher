...
export const initialState = {
    ...
    // This field determines if the user-emails component
    // is mounted or not.
    isComponentMounted: false,

    // This flag field will determine if to scroll to the results emails each
    // time the emails are refreshed on the page or not. The scrolling
    // animation occurred only on mobile or small devices.
    isScrollToResults: false,

    // This field represents the loading animation on the on
    ...
    // responsible for the data used in the user-emails page and for the
    ...
    // after the user deleted an email from his emails list and waited
    ...
    // update in this object. If needed, if an unexpected error occurred,
