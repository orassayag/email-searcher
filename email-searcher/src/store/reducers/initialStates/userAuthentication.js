...
export const initialState = {
    ...
    // or not (For example, when the user switches between login
    ...
    // This field will hold a general error message that will be re-assign
    // and displayed to the user once an unexpected error will occur during
    // the login / registration API call or the whole authentication saga.
    generalError: null
};